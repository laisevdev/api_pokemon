...
class TiposHabilidades(models.Model):
    tipo_01_img = models.ImageField(upload_to='tipos_images/', max_length=300, default='N/A', null=True)
    tipo_02_img = models.ImageField(upload_to='tipos_images/', max_length=300, default='N/A', null=True)
